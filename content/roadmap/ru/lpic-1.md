...
description: "LPIC-1 — домены экзамена, темы и трекер прогресса"
page_lang: "ru"
lang_pair: "/roadmap/lpic-1/"
...
<h1 class="rdm-h1">Linux <em>основы админа.</em></h1>
<p class="rdm-lead">44 тем по 2 экзаменам — с разборами на maks.top. Отмечай галочки по мере изучения, прогресс сохраняется в браузере.</p>

<div class="overall-progress">
<div class="op-header">
<span class="op-title">Общий прогресс</span>
<span class="op-count" id="op-count">44 / 44 тем · 100%</span>
</div>
...
<a href="/tags/lpic-1/" class="ql-btn">📚 Статьи LPIC-1</a>
</div>
...
<div class="rdm-section-label" style="margin-top:24px">Экзамен 101 — Hardware · Boot · CLI · Filesystems</div>
...
<div class="topic-item done" data-key="l1-101-3"><input type="checkbox" checked class="topic-cb" data-key="l1-101-3" data-domain="t101"><a href="/posts/lpic1/lpic1-101-3-runlevels-boot-targets/" class="topic-link">101.3 Runlevels / Boot Targets — SysV vs systemd targets, runlevel команды</a><span class="topic-tag">101.3</span></div>
</div>
</details></div>
...
<div class="domain-body">
<div class="topic-item done" data-key="l1-102-1"><input type="checkbox" checked class="topic-cb" data-key="l1-102-1" data-domain="t102"><a href="/posts/lpic1/lpic1-102-1-hard-disk-layout/" class="topic-link">102.1 Hard Disk Layout — MBR vs GPT, разделы, swap, LVM basics</a><span class="topic-tag">102.1</span></div>
...
<div class="domain-body">
<div class="topic-item done" data-key="l1-103-1"><input type="checkbox" checked class="topic-cb" data-key="l1-103-1" data-domain="t103"><a href="/posts/lpic1/lpic1-103-1-work-on-command-line/" class="topic-link">103.1 Work on the Command Line — bash, история, переменные, алиасы</a><span class="topic-tag">103.1</span></div>
...
<div class="topic-item done" data-key="l1-103-8"><input type="checkbox" checked class="topic-cb" data-key="l1-103-8" data-domain="t103"><a href="/posts/lpic1/lpic1-103-8-basic-file-editing/" class="topic-link">103.8 Basic File Editing — vi/vim команды, nano</a><span class="topic-tag">103.8</span></div>
</div>
</details></div>
...
<div class="topic-item done" data-key="l1-104-6"><input type="checkbox" checked class="topic-cb" data-key="l1-104-6" data-domain="t104"><a href="/posts/lpic1/lpic1-104-6-links/" class="topic-link">104.6 Hard & Symbolic Links — ln, inode, различия</a><span class="topic-tag">104.6</span></div>
...
<div class="rdm-section-label" style="margin-top:24px">Экзамен 102 — Shell · GUI · Users · System · Network · Security</div>
...
<div class="topic-item done" data-key="l1-105-2-1"><input type="checkbox" checked class="topic-cb" data-key="l1-105-2-1" data-domain="t105"><a href="/posts/lpic1/lpic1-105-2-1-scripts/" class="topic-link">105.2 Shell Scripts (Part 1) — shebang, условия, циклы, test</a><span class="topic-tag">105.2</span></div>
<div class="topic-item done" data-key="l1-105-2-2"><input type="checkbox" checked class="topic-cb" data-key="l1-105-2-2" data-domain="t105"><a href="/posts/lpic1/lpic1-105-2-2-scripts/" class="topic-link">105.2 Shell Scripts (Part 2) — функции, массивы, case, read</a><span class="topic-tag">105.2+</span></div>
</div>
</details></div>
...
<div class="topic-item done" data-key="l1-106-3"><input type="checkbox" checked class="topic-cb" data-key="l1-106-3" data-domain="t106"><a href="/posts/lpic1/lpic1-106-3-accessibility/" class="topic-link">106.3 Accessibility — orca, brltty, визуальные настройки</a><span class="topic-tag">106.3</span></div>
</div>
</details></div>
