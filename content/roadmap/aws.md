...
<div class="topic-item" data-phase="p3" data-key="aws-p3-07"><input type="checkbox" class="topic-cb" data-key="aws-p3-07" data-domain="p3"><span class="topic-text">Kinesis Data Streams vs Firehose — key: Firehose buffers 60s, Streams real-time</span></div>
