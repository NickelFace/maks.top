...
Со стороны провайдера нет смысла показывать конфигурацию.
...
! На R25 поднимаем сеть Loopback и добавляем статический маршрут к ней.
! На стороне провайдера работает OSPF — там ничего не настраивалось, кроме анонса сети.
