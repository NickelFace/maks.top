...
code_toggle: true
page_lang: "ru"
lang_pair: "/posts/neteng-09-ospf-filter/"
...
### R14–R15 находятся в зоне 0 — backbone
...
### R12–R13 находятся в зоне 10. Дополнительно к маршрутам должны получать маршрут по умолчанию
...
Теперь посмотрим таблицу маршрутизации на R12 / R13:
...
### R20 находится в зоне 102 и получает все маршруты, кроме маршрутов до сетей зоны 101
...
Как видно, сеть 10.10.10.12/30 (зона 101) отсутствует в таблице — задача выполнена.
