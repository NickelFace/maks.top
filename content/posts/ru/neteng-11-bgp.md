...
### Настройте eBGP между Ламас (заодно и Киторн) и Триада
...
### Проверьте IP-доступность между офисами Москва и С.-Петербург
...
**Полные конфигурации роутеров доступны здесь:**
