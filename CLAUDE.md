...
- Минимальный код, решающий задачу — ничего «на будущее»
- Никаких абстракций для разового использования
- Никакой гибкости/конфигурируемости, о которой не просили
- Если 50 строк делают то же что 200 — переписать
- Тест: senior engineer сказал бы «overcomplicated»? → упростить

## Goal-Driven Execution

Для многошаговых задач — явный план перед реализацией:
...
Таблица критериев успеха для этого проекта:
